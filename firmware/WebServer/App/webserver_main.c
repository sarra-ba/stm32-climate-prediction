...
void app_entry(void)
{
  ...
  /* Initialize Store & Forward module */
  SF_Init();
  printf("✓ Store & Forward module initialized\n\n");
  /* Initialize Dataset Logger */
  Dataset_Init();
  printf("✓ Dataset logger ready for AI training data\n\n");

  /* Start web server - NEVER RETURNS */
